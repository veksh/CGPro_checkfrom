...
sub processFile {
  ...
  #   A mt.maxidom.ru
  #   S HTTP [10.1.11.6]
  #   P I 13-04-2012 16:17:43 0000 ____ ____ <alice@mt.maxidom.ru>
  #   O L
  #   R W 13-04-2012 16:17:43 0000 ____ _FY_ <bob@mt.maxidom.ru>
  # or for pronto-generated message
  #   S HTTPU [10.1.11.6]
  #   A maxidom.ru
  #   O L
  #   P I 10-04-2013 11:22:43 0000 ____ ____ <alex@maxidom.ru>
  #   R W 10-04-2013 11:22:43 0000 ____ _FY_ <knjaz@maxidom.ru>
  # or for bounce with web user interface
  #   P I 25-03-2013 08:34:46 0000 ____ ____ <alice@mt.maxidom.ru>
  #   O L
  #   S WEBUSER [0.0.0.0]
  #   A mt.maxidom.ru
  #   R W 25-03-2013 08:34:46 0000 ____ _FY_ <alex@mt.maxidom.ru>
  # or for undeliverable/DSN report to postmaster
  #   P I 25-03-2013 12:52:22 0000 ____ ____ <>
  #   O L
  #   S DSN [0.0.0.0]
  #   R W 25-03-2013 12:52:22 0000 ____ ____ <alice@mt.maxidom.ru>
  #   R W 25-03-2013 12:52:22 0000 ____ ____ <postmaster>
  # or for rule-generated message  
  #   P I 25-03-2013 12:52:22 0000 ____ ____ <>
  #   O L
  #   S RULE [0.0.0.0]
  #   A drone.m1.maxidom.ru
  #   R W 25-03-2013 12:52:22 0000 ____ ____ <alex@mt.maxidom.ru>
  # or for rule-generated bounce (vacation redirect; also has 'X-Autogenerated: Redirect' header)
  #   S RULE [0.0.0.0]
  #   A maxidom.ru
  #   O L
  #   P I 10-04-2013 11:22:43 0000 ____ ____ <knjaz@maxidom.ru>
  #   R W 10-04-2013 11:22:43 0000 ____ ____ <dubinin.ivan@gmail.com>
  # or for calendar alarm
  #   P I 26-03-2013 05:12:00 0000 ____ ____ <>
  #   R W 26-03-2013 05:12:00 0000 ____ _F__ <max@mt.maxidom.ru>
  #   O LH
  #   S ALARM [0.0.0.0]
  ...
  while (my $line = <FILE>) {
    ...
    if (! $authName && $line =~ /^Sender: <(\S+)\@(\S+)>/) {
      ...
      # like "Received: from [10.1.11.6] (account alice@mt.maxidom.ru)"
      # or "Received: from [194.85.103.16] (account pot@maxidom.ru HELO pot)"
      ...
      if ($line =~ /From: (?!<)(\S+\@\S+)$/) {
        ...
        #  =?utf-8?B?INCS0LXQutGI0LjQvQ==?=" <alex@maxidom.ru>
      ...
      # Message-ID: <web-101261@drone.m1.maxidom.ru>
      $messageId = $1;
      reply('DEBUG', "found msg id <$messageId>");
    } elsif (!$origMessageId && $line =~ /^X-Original-Message-I[Dd]: <([^>]+)>/) {
      # X-Original-Message-Id: <98C5B147-8BA9-4359-81F4-79AA149610A8@maxidom.ru
      $origMessageId = $1;
...
=item trimDomain
trim leftmost part of domain: "vasia@mt.maxidom.ru" would pass for "vasia@maxidom.ru".

=item moveDomain
move leftmost part of domain to name: "vasia@mt.maxidom.ru" could use "vasia-mt@maxidom.ru".
...
=item * GETACCOUNTALIASES alice@mt.maxidom.ru

=item * FINDFORWARDERS mt.maxidom.ru TO alice@mt.maxidom.ru
